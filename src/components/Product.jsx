  ...
  return (
    <li className="w-full mx-auto">
      <div className="relative mb-8 mx-auto flex flex-col justify-center">
        <div className="product-button absolute -bottom-4 left-2/4 -translate-x-2/4 flex justify-center items-center w-fit">
          <div className="flex justify-between items-center rounded-full text-sm font-medium ">

            {/* Initial button to add the first product */}
            {totalQuantity < 1 &&
              <button disabled={!enableProduct} onClick={() => handleCart('add')} className="min-w-36 flex justify-center items-center gap-x-2 py-2 px-4 border border-gray-400 bg-white rounded-full hover:border-orange-700 hover:text-orange-700 transition-colors group">
            ...
            {totalQuantity > 0 &&
              <div className="min-w-36 flex justify-between w-full px-3 py-2 bg-orange-700 border border-orange-700 text-white rounded-full">
